...
class HToTaumuTauh : public Selection {
 ...
 protected:
  ...
  std::vector<TH1D> MetMVAPt;
  std::vector<TH1D> MetMVAPhi;
  std::vector<TH1D> MetMVADPhiMuon;
  std::vector<TH1D> MetMVACosDPhiMuon;
  std::vector<TH1D> MetMVAmTMuon;
  std::vector<TH1D> MetMVAMuTauPt;
  std::vector<TH1D> MetMVAMuTauPhi;
  std::vector<TH1D> MetMVAMuTauDPhiMuon;
  std::vector<TH1D> MetMVAMuTauCosDPhiMuon;
  std::vector<TH1D> MetMVAMuTaumTMuon;
  std::vector<TH1D> MetUncorrPt;
  std::vector<TH1D> MetUncorrPhi;
  std::vector<TH1D> MetUncorrDPhiMuon;
  std::vector<TH1D> MetUncorrCosDPhiMuon;
  std::vector<TH1D> MetUncorrmTMuon;
  std::vector<TH1D> MetCorrT0rtPt;
  std::vector<TH1D> MetCorrT0rtPhi;
  std::vector<TH1D> MetCorrT0rtDPhiMuon;
  std::vector<TH1D> MetCorrT0rtCosDPhiMuon;
  std::vector<TH1D> MetCorrT0rtmTMuon;
  std::vector<TH1D> MetCorrT0rtT1Pt;
  std::vector<TH1D> MetCorrT0rtT1Phi;
  std::vector<TH1D> MetCorrT0rtT1DPhiMuon;
  std::vector<TH1D> MetCorrT0rtT1CosDPhiMuon;
  std::vector<TH1D> MetCorrT0rtT1mTMuon;
  std::vector<TH1D> MetCorrT0pcPt;
  std::vector<TH1D> MetCorrT0pcPhi;
  std::vector<TH1D> MetCorrT0pcDPhiMuon;
  std::vector<TH1D> MetCorrT0pcCosDPhiMuon;
  std::vector<TH1D> MetCorrT0pcmTMuon;
  std::vector<TH1D> MetCorrT0pcT1Pt;
  std::vector<TH1D> MetCorrT0pcT1Phi;
  std::vector<TH1D> MetCorrT0pcT1DPhiMuon;
  std::vector<TH1D> MetCorrT0pcT1CosDPhiMuon;
  std::vector<TH1D> MetCorrT0pcT1mTMuon;
  std::vector<TH1D> MetCorrT0rtTxyPt;
  std::vector<TH1D> MetCorrT0rtTxyPhi;
  std::vector<TH1D> MetCorrT0rtTxyDPhiMuon;
  std::vector<TH1D> MetCorrT0rtTxyCosDPhiMuon;
  std::vector<TH1D> MetCorrT0rtTxymTMuon;
  std::vector<TH1D> MetCorrT0rtT1TxyPt;
  std::vector<TH1D> MetCorrT0rtT1TxyPhi;
  std::vector<TH1D> MetCorrT0rtT1TxyDPhiMuon;
  std::vector<TH1D> MetCorrT0rtT1TxyCosDPhiMuon;
  std::vector<TH1D> MetCorrT0rtT1TxymTMuon;
  std::vector<TH1D> MetCorrT0pcTxyPt;
  std::vector<TH1D> MetCorrT0pcTxyPhi;
  std::vector<TH1D> MetCorrT0pcTxyDPhiMuon;
  std::vector<TH1D> MetCorrT0pcTxyCosDPhiMuon;
  std::vector<TH1D> MetCorrT0pcTxymTMuon;
  std::vector<TH1D> MetCorrT0pcT1TxyPt;
  std::vector<TH1D> MetCorrT0pcT1TxyPhi;
  std::vector<TH1D> MetCorrT0pcT1TxyDPhiMuon;
  std::vector<TH1D> MetCorrT0pcT1TxyCosDPhiMuon;
  std::vector<TH1D> MetCorrT0pcT1TxymTMuon;
  std::vector<TH1D> MetCorrT1Pt;
  std::vector<TH1D> MetCorrT1Phi;
  std::vector<TH1D> MetCorrT1DPhiMuon;
  std::vector<TH1D> MetCorrT1CosDPhiMuon;
  std::vector<TH1D> MetCorrT1mTMuon;
  std::vector<TH1D> MetCorrT1TxyPt;
  std::vector<TH1D> MetCorrT1TxyPhi;
  std::vector<TH1D> MetCorrT1TxyDPhiMuon;
  std::vector<TH1D> MetCorrT1TxyCosDPhiMuon;
  std::vector<TH1D> MetCorrT1TxymTMuon;
  std::vector<TH1D> MetCorrCaloT1Pt;
  std::vector<TH1D> MetCorrCaloT1Phi;
  std::vector<TH1D> MetCorrCaloT1DPhiMuon;
  std::vector<TH1D> MetCorrCaloT1CosDPhiMuon;
  std::vector<TH1D> MetCorrCaloT1mTMuon;
  std::vector<TH1D> MetCorrCaloT1T2Pt;
  std::vector<TH1D> MetCorrCaloT1T2Phi;
  std::vector<TH1D> MetCorrCaloT1T2DPhiMuon;
  std::vector<TH1D> MetCorrCaloT1T2CosDPhiMuon;
  std::vector<TH1D> MetCorrCaloT1T2mTMuon;
